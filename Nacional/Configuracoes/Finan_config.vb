Public Class Finan_config
    ...
    Private Sub Finan_config_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        tarifa_txt.Text = tarifaI.ToString("C")
    ...
    Private Sub Tarifa_txt_Leave(sender As Object, e As EventArgs) Handles tarifa_txt.Leave
        If sender.text <> "" Then
            tarifaI = sender.text
            sender.text = tarifaI.ToString("C")
        End If
    End Sub
    ...
    Private Sub RadioButton1_CheckedChanged(sender As Object, e As EventArgs) Handles RadioButton4.CheckedChanged, RadioButton3.CheckedChanged, RadioButton2.CheckedChanged, RadioButton1.CheckedChanged, RadioButton5.CheckedChanged
